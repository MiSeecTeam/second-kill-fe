        ...
        return (
            <FormItem {...formItemLayout} label={this.props.label}>
                {getFieldDecorator(this.props.name, {
                    rules: [
                        {
                        type: this.props.type, message: (message==""?'Not an effective ' + this.props.type:message),
                        }, 
                        {
                        required: this.props.required, message: (message==""?'Please enter your ' + this.props.name + ' !':message),
                        }
                    ],
